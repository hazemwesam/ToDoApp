...
// require_once("handelers/delete-task.php");
// require_once("handelers/store-task.php");
// require_once("handelers/update-task.php");
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="handelers/store-task.php">Add User</a>
                </li>
                <li class="nav-item">
